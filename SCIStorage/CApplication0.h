...
public:
	...
	{
		BOOL result;
		InvokeHelper(0xce2, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_CSVKeepLeadingZerosAsText(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0xce2, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	BOOL get_CSVKeepLargeNumbersAsText()
	{
		BOOL result;
		InvokeHelper(0xce3, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_CSVKeepLargeNumbersAsText(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
		InvokeHelper(0xce3, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
