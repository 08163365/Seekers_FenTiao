...
public:
	...
	{
		LPDISPATCH result;
		InvokeHelper(0xd04, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
	long get_Decorative()
	{
		long result;
		InvokeHelper(0xd05, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_Decorative(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0xd05, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
